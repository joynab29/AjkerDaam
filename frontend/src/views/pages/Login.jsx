            ...
            <div className="relative">
              ...
              <div className="text-center space-y-md">
                ...
                <div className="grid grid-cols-2 gap-sm">
                  ...
                  <Link to="/signup?role=admin" className="flex items-center justify-center gap-2 px-4 py-2 border border-outline-variant/40 rounded-lg hover:bg-surface-container transition-colors text-on-surface-variant font-label-sm">
                    <span className="material-symbols-outlined text-body-md" data-icon="shield_person">shield_person</span>
                    Admin
                  </Link>
                </div>
              </div>
